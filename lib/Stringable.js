module.exports = Stringable = class {
     ...
     * @return { this }
     */
    stripTags(allowedTags = null) {
        methodNotImplemented('stripTags');
    }
    ...
    trim(characters = null) {
        let characterArray = Array.isArray(characters) ? characters : new Array(...arguments);
     ...
     */
    toHtmlString() {
        methodNotImplemented('toHtmlString');
    }
     ...
     */
    toInteger() {
        return !isNaN(this.value) ? parseInt(this.value) : 0;
    }
     ...
     */
    toFloat() {
        return !isNaN(this.value) ? parseFloat(this.value) : 0;
    }
