const HtmlString = require('./HtmlString.js');
...
module.exports = Stringable = class {
     ...
     *
     * @return { HtmlString|HTMLElement|string }
     */
    toHtmlString() {
    ...
    toDate(format = null, tz = null) {
        ...
        let days            = [];
        let months          = [];
        const now           = new Date(new Date(this.value).toLocaleString('en-US', { timeZone: tz ?? undefined }));
